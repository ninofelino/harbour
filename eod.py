...
for item in DBF('/home/server/Downloads/INV-HO.DBF',encoding='iso-8859-1'):
    ...
    #  print  list(item.values())
     ...
     # print item['CODE'],item['DESC1'],item['LQOH']
      ...
      ") VALUES ("\
      +item['CODE']+",'"+item['DESC1'].replace("'","")+"',1,'consu',False,1,"+str(item['COSTPRC'])+",True,True,1,1,1,True,1,'no-message','none','no-message') ON CONFLICT ON CONSTRAINT product_template_pkey DO Update set sale_ok=True,list_price="+str(item['SELLPRC'])+" ;"
